...
[the national sport of countries](http://www.downloadexcelfiles.com/wo_en/download-excel-file-list-national-sports#.WejsvEwZM_V) from here.

I had to clean this dataset as it had weird line spacings and multiple sports for only some countries. I did so using my text editor. Once I got it in a form I liked, I read it unsing the read_csv function. I then extracted information on the levels of the variable country. I then used this information to choose only those countries from the gapminder dataset. 
